...
<section class="w-full">
    ...
    <footer class="bg-black  text-white ">
        {{-- ===================== --}}
        <div class="px-4 py-6 bg-black md:flex md:items-center md:justify-between `-montserrat">
           <div class="flex gap-10 flex-wrap">
            ...
            <span><a href="">+41 22 715 7000</a></span>
           </div>
        ...
        <div class="mx-auto w-full ">
          <div class="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-5 ">
            ...
            <div>
                <h2 class="mb-6 text-sm font-semibold text-white uppercase dark:text-white">classes</h2>
                <ul class="text-gray-500 dark:text-gray-400 font-medium">
                    <li class="mb-4">
