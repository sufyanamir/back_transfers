...
<section class="Hero   ">
    <div class="relative ">
        <img src="https://images.unsplash.com/photo-1632154939368-1a92207d8af3?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8Y2FyJTIwaW1hZ2VzfGVufDB8MHwwfHx8MA%3D%3D"
        ...
        {{--  --}}
        <div
            class="header_bottom lg:left-[15%]  w-[1024px]   hidden lg:block rounded-full bg-white absolute bottom-10  py-3 px-2">
            <div class="flex items-center  justify-between">
                ...
                {{-- search bar --}}
                <div class="relative">
                    <img src="{{asset('assets/icons/search.svg')}}"alt="" class="absolute top-3 left-2  z-10 bg-black  ">
                    <input type="text" placeholder="Search" class="relative rounded-full outline-none px-10 w-32 bg-black text-white py-3">
                </div>
                      ...
                      <div>
                         ...
                         <div class="flex flex-col gap-10">
                            <div class="w-[389px] flex flex-col gap-2">
                                <div><p>Create Your Route</p></div>
                                <div><p>Enter your pickup & dropoff locations or the number of hours you wish to book a car and driver for</p></div>
                             </div>
                             {{--  --}}
                             <div class="w-[389px] flex flex-col gap-2">
                                <div><p>Choose Vehicle For You</p></div>
                                <div><p>On the day of your ride, you will receive two email and SMS updates - one informing you that.</p></div>
                             </div>
                             {{--  --}}
                             <div class="w-[389px] flex flex-col gap-2">
                                <div><p>Enjoy The Journey</p></div>
                                <div><p>After your ride has taken place, we would appreciate it if you could rate your car and driver.</p></div>
                             </div>
                         </div>
    ...
    <div class= " bg-image px-5 text-white w-full  object-cover  mb-10 py-10">
       <div class="content_container flex flex-col gap-5">
        ...
        <div class="font-montserrat flex flex-col gap-2">
            ...
            <div class="">
             <p class="text-[12px]">On the day of your ride, you will receive two email and SMS updates - one informing you that.</p>
            </div>
        </div>
...
<section class="w-full py-20 hidden lg:block">
    <div class="Numbers_image h-full">
        <div class="w-[1170px] mx-auto grid grid-cols-1 lg:grid-cols-2 py-20 capitalize  px-10 text-white font-montserrat">
           <div class="w-[470px]">
            <p class="text-4xl">
...
<section class="w-full   bg-pink flex  flex-wrap px-5">
        ...
        <div class="  flex-1 flex flex-col gap-10 font-montserrat py-10   justify-center max-w-[470px] mx-auto">
            <div><h1 class="text-4xl">Download the app</h1></div>
