   ...
   <span>Dashboard - Edit Profile</span>
    ...
    <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
       <div class="grid xl:grid-cols-4 gap-4 mb-4">
          <div class="flex items-center gap-5 justify-center  py-10 rounded-xl bg-white shadow-2xl dark:bg-gray-800">
             <div class="bg-slate-100 rounded-xl w-20 h-20 flex justify-center items-center">
                 <img src={{asset('assets/icons/mybooking.svg')}} alt="">
             </div>
          ...
          <div class="flex items-center gap-5 justify-center  py-10 rounded-xl bg-white shadow-2xl dark:bg-gray-800">
            <div class="bg-slate-100 rounded-xl w-20 h-20 flex justify-center items-center">
                <img src={{asset('assets/icons/invoice.svg')}} alt="">
            </div>
            <div class="flex flex-col justify-center items-center  w-[132px]">
         ...
         <div class="flex items-center gap-5 justify-center  py-10 rounded-xl bg-white shadow-2xl dark:bg-gray-800">
            <div class="bg-slate-100 rounded-xl w-20 h-20 flex justify-center items-center">
                <img src={{asset('assets/icons/pendingPayment.svg')}} alt="">
            </div>
